...
<article id="post-<?php the_ID(); ?>" <?php post_class('gk-event-cat'); ?>>
	...
	<div class="event-description">
		<header>
			...
			<?php endif; ?>
			<ul>
			<li><strong><?php _e( 'When: ', GKTPLNAME ); ?></strong><?php echo $date_start->format('d F Y'); ?> - <?php echo $date_end->format('d F Y'); ?> @ <?php echo $date_start->format('g:i a'); ?> - <?php echo $date_end->format('g:i a'); ?></li>
			</ul>
		</header>
